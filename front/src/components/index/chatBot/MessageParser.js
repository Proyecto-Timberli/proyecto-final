...
class MessageParser {
    ...
    parse(message) {
        ...
        } else if (lowerCaseMessage.includes('proyecto'))  {
        ...
        } else if (lowerCaseMessage.includes('precio') || lowerCaseMessage.includes('valor') || lowerCaseMessage.includes('cuesta') || lowerCaseMessage.includes('sale')) {
            return this.actionProvider.handleContribuciones();
        } else if (lowerCaseMessage.includes('timberli') || lowerCaseMessage.includes('equipo') || lowerCaseMessage.includes('persona') || lowerCaseMessage.includes('robot')) {
