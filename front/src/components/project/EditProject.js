...
function EditProject({ id, defaultValue, desplegarEditar }) {
    ...
    function handleInputImage(e) {
        ...
        setEditValue({
            ...editValue,
            [e.target.name]: [e.target.files[0], ...editValue.imagen]
        })
    }
    ...
    function deletePhoto(e) {
        ...
        setEditValue({
            ...editValue,
            imagen: editValue.imagen.filter((e, i) => i !== indexInput)
        })
        ...
        <React.Fragment>
            <div className="project-edit-container">
                ...
                <div className="project-edit-div-tecnologias">
                    ...
                    <div className="project-edit-div-white">
                        <div className="project-edit-div-multimedia"><h3>Imagenes y video</h3><input type="file" onChange={handleInputImage} accept="image/*,video/*" name="imagen" className="project-edit-input" /></div>
                    </div>
                    <div className="project-edit-div-white">
                        <div className="project-edit-div-multimedia">
                            <h3>Preview</h3>
